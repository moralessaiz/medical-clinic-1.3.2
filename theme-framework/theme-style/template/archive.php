	...
	<div class="cmsmasters_archive_item_cont_wrap">
		...
		if (cmsmasters_title(get_the_ID(), false) != get_the_ID()) {
			if(get_post_type() == 'project' && $cmsmasters_project_link_url != "") {
				medical_clinic_project_heading(get_the_ID(), 'h2', $cmsmasters_project_link_redirect, $cmsmasters_project_link_url, $cmsmasters_project_link_target);
			} else {			
			?>
		...
		if (medical_clinic_excerpt(55, false) != '') {
